# Search/Download Appeal Decisions

## Overview

Download appeal decision search results as a file. Supports JSON and CSV formats.
...
- `search_appeal_decisions_download_get()` - GET method
- `search_appeal_decisions_download()` - POST method
...
async def download_json():
    ...
    results = await client.search_appeal_decisions_download_get(
