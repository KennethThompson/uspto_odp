# Get Interference Decision

## Overview

Retrieve a specific interference decision document by its document identifier.
...
- `get_interference_decision(document_identifier: str) -> InterferenceDecisionIdentifierResponseBag`
