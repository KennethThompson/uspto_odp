# Search/Download Trial Decisions

## Overview

Download trial decision search results as a file. Supports JSON and CSV formats.
...
- `search_trial_decisions_download_get()` - GET method
- `search_trial_decisions_download()` - POST method
...
async def download_json():
    ...
    results = await client.search_trial_decisions_download_get(
